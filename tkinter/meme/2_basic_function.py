...
def merge_images():
	...
	merge_desktop_path = os.path.join(save_desktop_path.get(), "MEME.jpg")
...
btn_desktop_save = Button(save_frame, text = "Search", width=10, command = save_path_browse)
